...
<head>
    ...
    <title>Управление брендами - AnaLeg</title>
    ...
    <main>
        ...
        <div class="admin-section">
            ...
            <h2>Список брендов</h2>
             <a href="add_brand.php" class="btn-primary" style="width: auto; margin-bottom: 20px;">Добавить новый бренд</a>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    <?php foreach ($brands as $brand): ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($brand['logo']): ?>
                                    <img src="../<?php echo htmlspecialchars($brand['logo']); ?>" alt="Логотип <?php echo htmlspecialchars($brand['name']); ?>" width="50">
                                <?php else: ?>
                                    Нет логотипа
                                <?php endif; ?>
                            </td>
                            <td class="action-links">
                                <a href="edit_brand.php?id=<?php echo $brand['id']; ?>">Редактировать</a>
                                <a href="delete_brand.php?id=<?php echo $brand['id']; ?>" onclick="return confirm('Вы уверены, что хотите удалить этот бренд?');">Удалить</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
